...
namespace Platinum.Core.Utils
{
    ...
    public static class WindowsUtils
    {
        ...
        public static string GetDotnetVersion()
        {
            ...
            TryGetRegistryKey(@"SOFTWARE\Microsoft\NET Framework Setup\NDP\v4\Full\", "Release", out dynamic value);
        ...
        private static string _WindowsVersion = null;
