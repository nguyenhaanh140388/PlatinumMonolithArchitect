// <copyright file="FileHelpers.cs" company="Anhny010920">
...
namespace Platinum.Core.Helpers
{
    ...
    public static class FileHelper
    {
        ...
        /// <summary>
        /// Processes the form file.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="formFile">The form file.</param>
        /// <param name="modelState">State of the model.</param>
        /// <param name="permittedExtensions">The permitted extensions.</param>
        ...
        /// <summary>
        /// Determines whether [is valid file extension and signature] [the specified file name].
        /// </summary>
        /// <param name="fileName">Name of the file.</param>
        /// <param name="data">The data.</param>
        /// <param name="permittedExtensions">The permitted extensions.</param>
        /// <returns>
        ///   <c>true</c> if [is valid file extension and signature] [the specified file name]; otherwise, <c>false</c>.
        /// </returns>
